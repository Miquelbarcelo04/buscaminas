    ...
    mostrarTablero() {
        ...
        for (let fila = 0; fila < this.filas; fila++) {
            for (let columna = 0; columna < this.columnas; columna++) {
                ...
                casillaElemento === null || casillaElemento === void 0 ? void 0 : casillaElemento.addEventListener('click', () => {
                    this.revelarCasilla(fila, columna);
                });
                // EventListener para clic derecho
                casillaElemento === null || casillaElemento === void 0 ? void 0 : casillaElemento.addEventListener('contextmenu', (event) => {
